...
<head>
    ...
    <!-- style CSS -->
    <link rel="stylesheet" href="css/BusTicketPrices.css">
            ...
            <div class="col-lg-12">
                <div class="breadcrumb_iner text-center">
                    <div class="breadcrumb_iner_item">
                        <h2>Bus Ticket Price Details</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="d-none d-sm-block mb-5 pb-4">
                ...
                <div class="section-top-border">
                    <h3 class="mb-30">Bus Ticket Price Details</h3>
                    <div class="progress-table">
                        <div class="table-head">
                            <div class="RouteNo">Route No</div>
                            <div class="RouteName">Route Name</div>
                            <div class="noOfBusStops">No Of Bus Stops</div>
                            <div class="Price">Ticket Price Per Stop</div>
                        </div>
                        <%
                            try{
                                ...
                                String query ="SELECT * FROM BusTicketDetails";
                                ResultSet resultSet = myStm.executeQuery(query);
                                while(resultSet.next()){
                        %>
                        <div class="table-row">
                            <div class="RouteNo"><%=resultSet.getString(2) %></div>
                            <div class="RouteName"><%=resultSet.getString(3) %></div>
                            <div class="noOfBusStops"><%=resultSet.getString(4) %></div>
                            <div class="Price"><%=resultSet.getString(5) %></div>
                        </div>
                        <%
                                }
                                connection.close();
