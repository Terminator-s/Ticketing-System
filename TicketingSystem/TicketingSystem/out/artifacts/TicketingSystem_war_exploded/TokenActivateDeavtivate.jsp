...
<head>
    ...
    <!-- style CSS -->
    <link rel="stylesheet" href="css/tokenActivate.css">
</head>
            ...
            <div class="col-lg-12">
                <div class="breadcrumb_iner text-center">
                    <div class="breadcrumb_iner_item">
                        <h2>Token Activate or Deactivate</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div>
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <h3 class="mb-30">Token Activate or Deactivate</h3>
                        <form action="#">
                            <div class="mt-10">
                                 <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9"
                                           onfocus="this.placeholder = ''" onblur="this.placeholder = 'Reason for Activate/ Deactivate'"
                                            placeholder='Reason for Activate/ Deactivate'></textarea>
                            </div>
                            <div class="mt-10">
                                <input type="text" name="Token_Number" placeholder="Token Number"
                                       onfocus="this.placeholder = ''" onblur="this.placeholder = 'Token Number'" required
                                       class="single-input">
                            </div>
                            <div class="mt-10">
                                <input type="password" name="Token_password" placeholder="Password"
                                       onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'" required
                                       class="single-input">
                            </div>
                            <div class="switch-wrap d-flex justify-content-between mt-10">
                                <p>Token Activate/ Deactivate</p>
                            ...
                            <div class="mt-10">
                                <a href="home.jsp" class="genric-btn info circle arrow">Update</a>
                            </div>
                        </form>
                    </div>
                </div>
