                        ...
                        <form action="#">
                            <table>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="mt-12">
                                            <input type="text" name="token no" placeholder="Token Number" onfocus="this.placeholder = ''"
                            ...
                            <div class="mt-10">
                                <a href="editUser.jsp" class="genric-btn danger circle arrow">Edit</a>
                                <a href="TokenActivateDeavtivate.jsp" class="genric-btn success circle arrow">Token Activate/ Deactivate</a>
                            </div>
