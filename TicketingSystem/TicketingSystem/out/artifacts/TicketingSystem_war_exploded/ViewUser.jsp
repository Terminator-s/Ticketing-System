                ...
                <tr>
                    <%
                        try{
                            ...
                            String query ="SELECT * FROM tourbiUsers";
                            ResultSet resultSet = myStm.executeQuery(query);
                            while(resultSet.next()){
                    %>
                    <th scope="col"><%=resultSet.getString(1) %></th>
                    <th scope="col"><%=resultSet.getString(2) %></th>
                    <th scope="col"><%=resultSet.getString(3) %></th>
                    <th scope="col"><%=resultSet.getString(4) %></th>
                    <th scope="col"><%=resultSet.getString(5) %></th>
                    <th scope="col"><%=resultSet.getString(6) %></th>
                    <th scope="col"><%=resultSet.getString(7) %></th>
                    <th scope="col"><%=resultSet.getString(8) %></th>
                    <th scope="col"><%=resultSet.getString(9) %></th>
                    <th scope="col"><%=resultSet.getString(10) %></th>
                    <th scope="col"><%=resultSet.getString(11)%></th>
                    <th scope="col">
                        <form method="POST" action="DeleteUserServlet?id=<%=resultSet.getString(3)%>">
                            <a href="editUser.jsp" class="genric-btn danger circle arrow">Delete</a>
                        </form>
                    </th>
                </tr>
                <%
