        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6">
                <div class="single_popular_place">
                    <img src="img/icon/local_user.png" alt="">
                    <h4>Righter Local User</h4>
                    <a href="AddLocalUser.jsp" class="genric-btn primary circle arrow">Righter</a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6">
                <div class="single_popular_place">
                    <img src="img/icon/foreign_user.png" alt="">
                    <h4>Righter Foreign User</h4>
                    <a href="AddForeignUser.jsp" class="genric-btn primary circle arrow">Righter</a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6">
                <div class="single_popular_place">
                    <img src="img/icon/user_details.png" alt="">
                    <h4>User Details</h4>
                    <a href="ViewUser.jsp" class="genric-btn primary circle arrow">View Details</a>
                </div>
            </div>
        </div>
    </div>
